...
They can outlive that parent without extending it. Unparented relayed work
stays unparented; no proof state or new trace carrier is transferred.
...
internal event queues and time outside the callback are excluded.
