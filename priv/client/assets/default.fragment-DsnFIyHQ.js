import{t as e}from"./shaderStore-D-XQlhUT.js";import{helperFunctions as t}from"./helperFunctions-CfAqjJVJ.js";import{i as ee,n as te,r as ne,t as re}from"./fogFragment-WPqtYpyX.js";import{a as ie,i as ae,n as oe,r as se,t as ce}from"./logDepthDeclaration-BKcd_JEL.js";var n=`decalFragmentDeclaration`,r=`#ifdef DECAL
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var je=[le,ue,ie,ae,se,de,fe,oe,t,pe,me,g,he,ge,_e,ve,ye,be,xe,N,Se,Ce,we,ee,ce,ne,te,Te,Ee,De,Oe,ke,re,Ae];for(let t of je)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var Me={name:Q,shader:$};export{Me as defaultPixelShader};