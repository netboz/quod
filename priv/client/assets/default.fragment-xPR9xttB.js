import{t as e}from"./shaderStore-D-XQlhUT.js";import{helperFunctionsWGSL as t}from"./helperFunctions-kaVETfyH.js";import{i as ee,n as te,r as n,t as r}from"./fogFragment-NFgubt9V.js";import{a as ne,i as re,n as ie,r as ae,t as oe}from"./logDepthDeclaration-CLGvI4QS.js";var i=`prePassDeclaration`,a=`#ifdef PREPASS
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var Se=[ne,re,ae,o,se,ie,t,ce,le,ue,_,b,de,fe,pe,k,me,P,L,he,ee,oe,n,te,ge,_e,ve,ye,be,r,xe];for(let t of Se)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var Ce={name:Q,shader:$};export{Ce as defaultPixelShaderWGSL};