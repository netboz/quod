...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var ee={name:p,shader:m},h=`shadowsFragmentFunctions`,g=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var _={name:h,shader:g},v=`samplerFragmentDeclaration`,y=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);var b={name:v,shader:y},x=`reflectionFunction`,S=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var C={name:x,shader:S},w=`imageProcessingDeclaration`,T=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=T);var E={name:w,shader:T},D=`imageProcessingFunctions`,O=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=O);var k={name:D,shader:O},A=`textureRepetitionFunctions`,j=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var M={name:A,shader:j},N=`bumpFragmentMainFunctions`,P=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=P);var F={name:N,shader:P},I=`bumpFragmentFunctions`,L=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=L);var te={name:I,shader:L},R=`bumpFragment`,z=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=z);var B={name:R,shader:z},V=`decalFragment`,H=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[V]||(e.IncludesShadersStoreWGSL[V]=H);var U={name:V,shader:H},W=`depthPrePass`,G=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=G);var K={name:W,shader:G},q=`lightFragment`,J=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[q]||(e.IncludesShadersStoreWGSL[q]=J);var Y={name:q,shader:J},X=`logDepthFragment`,Z=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var ne={name:X,shader:Z},Q=`oitFragment`,$=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[Q]||(e.IncludesShadersStoreWGSL[Q]=$);var re={name:Q,shader:$};export{l as _,U as a,F as c,E as d,C as f,f as g,ee as h,K as i,M as l,_ as m,ne as n,B as o,b as p,Y as r,te as s,re as t,k as u,o as v,r as y};