import{t as e}from"./shaderStore-D-XQlhUT.js";import{helperFunctionsWGSL as t}from"./helperFunctions-kaVETfyH.js";import{i as ee,n as te,r as ne,t as re}from"./fogFragment-NFgubt9V.js";import{i as ie,n as ae,r as oe,t as se}from"./logDepthDeclaration-BFRMqj0n.js";import{_ as ce,a as le,c as ue,d as de,f as fe,g as pe,h as me,i as he,l as ge,m as _e,n as ve,o as ye,p as be,r as xe,s as Se,t as Ce,u as we,v as Te,y as Ee}from"./oitFragment-BsTA2Ojp.js";import{n as De,r as Oe,t as ke}from"./pbrBRDFFunctions-CfZAdMUN.js";var n=`pbrFragmentExtraDeclaration`,Ae=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=Ae);var je={name:n,shader:Ae},r=`samplerFragmentAlternateDeclaration`,Me=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=Me);var Ne={name:r,shader:Me},i=`pbrFragmentReflectionDeclaration`,a=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=a);var Pe={name:i,shader:a},o=`pbrFragmentSamplersDeclaration`,s=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=s);var Fe={name:o,shader:s},c=`subSurfaceScatteringFunctions`,Ie=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=Ie);var Le={name:c,shader:Ie},l=`importanceSampling`,Re=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=Re);var ze={name:l,shader:Re},u=`pbrHelperFunctions`,d=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=d);var Be={name:u,shader:d},f=`pbrDirectLightingSetupFunctions`,p=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=p);var Ve={name:f,shader:p},m=`pbrDirectLightingFalloffFunctions`,He=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=He);var Ue={name:m,shader:He},h=`hdrFilteringFunctions`,We=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=We);var Ge={name:h,shader:We},g=`pbrBlockReflectance0`,_=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=_);var Ke={name:g,shader:_},v=`pbrDirectLightingFunctions`,y=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);var qe={name:v,shader:y},b=`pbrIBLFunctions`,x=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=x);var Je={name:b,shader:x},S=`pbrBlockAlbedoOpacity`,C=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=C);var Ye={name:S,shader:C},w=`pbrBlockReflectivity`,Xe=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=Xe);var Ze={name:w,shader:Xe},T=`pbrBlockAmbientOcclusion`,Qe=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=Qe);var $e={name:T,shader:Qe},E=`pbrBlockAlphaFresnel`,et=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=et);var tt={name:E,shader:et},D=`pbrBlockAnisotropic`,nt=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=nt);var rt={name:D,shader:nt},O=`pbrBlockReflection`,it=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=it);var at={name:O,shader:it},k=`pbrBlockSheen`,A=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[k]||(e.IncludesShadersStoreWGSL[k]=A);var ot={name:k,shader:A},j=`pbrBlockClearcoat`,M=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[j]||(e.IncludesShadersStoreWGSL[j]=M);var st={name:j,shader:M},N=`pbrBlockIridescence`,P=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=P);var ct={name:N,shader:P},F=`pbrBlockSubSurface`,I=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=I);var lt={name:F,shader:I},L=`pbrBlockNormalGeometric`,R=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=R);var ut={name:L,shader:R},z=`pbrBlockNormalFinal`,B=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[z]||(e.IncludesShadersStoreWGSL[z]=B);var dt={name:z,shader:B},V=`pbrBlockLightmapInit`,H=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[V]||(e.IncludesShadersStoreWGSL[V]=H);var ft={name:V,shader:H},U=`pbrBlockGeometryInfo`,pt=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=pt);var mt={name:U,shader:pt},W=`pbrBlockReflectance`,ht=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=ht);var gt={name:W,shader:ht},G=`pbrBlockDirectLighting`,_t=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=_t);var vt={name:G,shader:_t},K=`pbrBlockFinalLitComponents`,yt=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=yt);var bt={name:K,shader:yt},q=`pbrBlockFinalUnlitComponents`,J=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[q]||(e.IncludesShadersStoreWGSL[q]=J);var xt={name:q,shader:J},Y=`pbrBlockFinalColorComposition`,St=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[Y]||(e.IncludesShadersStoreWGSL[Y]=St);var Ct={name:Y,shader:St},X=`pbrBlockImageProcessing`,wt=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=wt);var Tt={name:X,shader:wt},Z=`pbrBlockPrePass`,Et=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[Z]||(e.IncludesShadersStoreWGSL[Z]=Et);var Dt={name:Z,shader:Et},Q=`pbrDebug`,Ot=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[Q]||(e.IncludesShadersStoreWGSL[Q]=Ot);var kt={name:Q,shader:Ot},$=`pbrPixelShader`,At=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[$]||(e.ShadersStoreWGSL[$]=At);var jt=[Ee,Te,ie,oe,Oe,ae,je,ce,be,Ne,Pe,Fe,de,ee,se,ne,ge,t,Le,ze,Be,we,_e,De,pe,Ve,Ue,ke,Ge,me,Ke,qe,Je,ue,Se,fe,le,Ye,Ze,$e,tt,rt,at,ot,st,ct,lt,te,ut,ye,dt,he,ft,mt,gt,vt,xe,bt,xt,Ct,ve,re,Tt,Dt,Ce,kt];for(let t of jt)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var Mt={name:$,shader:At};export{Mt as pbrPixelShaderWGSL};